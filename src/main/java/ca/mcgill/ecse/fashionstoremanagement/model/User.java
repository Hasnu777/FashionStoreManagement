...
// line 17 "../../../../../FashionStoreManagement.ump"
public class User
{
  ...
  public User(String aUsername, String aPassword, String aName, String aPhoneNumber, FashionStoreManagement aFashionStoreManagement)
  {
    password = aPassword;
    name = aName;
    ...
    {
      throw new RuntimeException("Unable to create user due to fashionStoreManagement. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  ...
  public boolean setFashionStoreManagement(FashionStoreManagement aFashionStoreManagement)
  {
    ...
    {
      existingFashionStoreManagement.removeUser(this);
    }
    fashionStoreManagement.addUser(this);
    wasSet = true;
    return wasSet;
  }
  ...
  public void delete()
  {
    ...
    {
      placeholderFashionStoreManagement.removeUser(this);
    }
