...
public class FashionStoreManagement
{
  ...
  //FashionStoreManagement Associations
  ...
  public boolean addUser(User aUser)
  {
    ...
    FashionStoreManagement existingFashionStoreManagement = aUser.getFashionStoreManagement();
    boolean isNewFashionStoreManagement = existingFashionStoreManagement != null && !this.equals(existingFashionStoreManagement);
    if (isNewFashionStoreManagement)
    {
      aUser.setFashionStoreManagement(this);
    }
    else
    {
      users.add(aUser);
  ...
  public boolean removeUser(User aUser)
  {
    ...
    //Unable to remove aUser, as it must always have a fashionStoreManagement
    if (!this.equals(aUser.getFashionStoreManagement()))
    {
      users.remove(aUser);
      wasRemoved = true;
    }
  ...
  public boolean addEmployee(Employee aEmployee)
  {
    ...
    FashionStoreManagement existingFashionStoreManagement = aEmployee.getFashionStoreManagement();
    boolean isNewFashionStoreManagement = existingFashionStoreManagement != null && !this.equals(existingFashionStoreManagement);
    if (isNewFashionStoreManagement)
    {
      aEmployee.setFashionStoreManagement(this);
    }
    else
    {
  ...
  {
    boolean wasRemoved = false;
    //Unable to remove aEmployee, as it must always have a fashionStoreManagement
    if (!this.equals(aEmployee.getFashionStoreManagement()))
    {
  ...
  /* Code from template association_AddManyToOne */
  public Customer addCustomer(User aUser, String aAddress, int aLoyaltyPoints)
  {
    return new Customer(aUser, aAddress, aLoyaltyPoints, this);
  }
  ...
  public boolean addCustomer(Customer aCustomer)
  {
    ...
    FashionStoreManagement existingFashionStoreManagement = aCustomer.getFashionStoreManagement();
    boolean isNewFashionStoreManagement = existingFashionStoreManagement != null && !this.equals(existingFashionStoreManagement);
    if (isNewFashionStoreManagement)
    {
      aCustomer.setFashionStoreManagement(this);
    }
    else
    {
  ...
  {
    boolean wasRemoved = false;
    //Unable to remove aCustomer, as it must always have a fashionStoreManagement
    if (!this.equals(aCustomer.getFashionStoreManagement()))
    {
  ...
  public boolean setManager(Manager aNewManager)
  {
    ...
    if (manager != null && !manager.equals(aNewManager) && equals(manager.getFashionStoreManagement()))
    {
    ...
    manager = aNewManager;
    FashionStoreManagement anOldFashionStoreManagement = aNewManager != null ? aNewManager.getFashionStoreManagement() : null;

    if (!this.equals(anOldFashionStoreManagement))
    {
      if (anOldFashionStoreManagement != null)
      {
        anOldFashionStoreManagement.manager = null;
      }
      if (manager != null)
      {
        manager.setFashionStoreManagement(this);
      }
    }
    wasSet = true;
    return wasSet;
  ...
  public boolean addOrder(Order aOrder)
  {
    ...
    FashionStoreManagement existingFashionStoreManagement = aOrder.getFashionStoreManagement();
    boolean isNewFashionStoreManagement = existingFashionStoreManagement != null && !this.equals(existingFashionStoreManagement);
    if (isNewFashionStoreManagement)
    {
      aOrder.setFashionStoreManagement(this);
    }
    else
    {
      orders.add(aOrder);
  ...
  {
    boolean wasRemoved = false;
    //Unable to remove aOrder, as it must always have a fashionStoreManagement
    if (!this.equals(aOrder.getFashionStoreManagement()))
    {
  ...
  /* Code from template association_AddManyToOne */
  public Item addItem(String aName, double aPrice, int aLoyaltyPoints)
  {
    return new Item(aName, aPrice, aLoyaltyPoints, this);
  }
  ...
  public boolean addItem(Item aItem)
  {
    ...
    FashionStoreManagement existingFashionStoreManagement = aItem.getFashionStoreManagement();
    boolean isNewFashionStoreManagement = existingFashionStoreManagement != null && !this.equals(existingFashionStoreManagement);
    if (isNewFashionStoreManagement)
    {
      aItem.setFashionStoreManagement(this);
    }
    else
    {
      items.add(aItem);
  ...
  {
    boolean wasRemoved = false;
    //Unable to remove aItem, as it must always have a fashionStoreManagement
    if (!this.equals(aItem.getFashionStoreManagement()))
    {
      items.remove(aItem);
      wasRemoved = true;
    }
  ...
  /* Code from template association_AddManyToOne */
  public SizedItem addSizedItem(SizedItem.Size aSize, int aQuantityInInventory, Item aItem)
  {
    return new SizedItem(aSize, aQuantityInInventory, this, aItem);
  }
  ...
  public boolean addSizedItem(SizedItem aSizedItem)
  {
    ...
    FashionStoreManagement existingFashionStoreManagement = aSizedItem.getFashionStoreManagement();
    boolean isNewFashionStoreManagement = existingFashionStoreManagement != null && !this.equals(existingFashionStoreManagement);
    if (isNewFashionStoreManagement)
    {
      aSizedItem.setFashionStoreManagement(this);
    }
    else
    {
  ...
  {
    boolean wasRemoved = false;
    //Unable to remove aSizedItem, as it must always have a fashionStoreManagement
    if (!this.equals(aSizedItem.getFashionStoreManagement()))
    {
  ...
  /* Code from template association_AddManyToOne */
  public Shipment addShipment(Date aDateOrdered, Date aDateArrived)
  {
    return new Shipment(aDateOrdered, aDateArrived, this);
  }
  ...
  public boolean addShipment(Shipment aShipment)
  {
    ...
    FashionStoreManagement existingFashionStoreManagement = aShipment.getFashionStoreManagement();
    boolean isNewFashionStoreManagement = existingFashionStoreManagement != null && !this.equals(existingFashionStoreManagement);
    if (isNewFashionStoreManagement)
    {
      aShipment.setFashionStoreManagement(this);
    }
    else
    {
  ...
  {
    boolean wasRemoved = false;
    //Unable to remove aShipment, as it must always have a fashionStoreManagement
    if (!this.equals(aShipment.getFashionStoreManagement()))
    {
  ...
  /* Code from template association_AddManyToOne */
  public OrderItem addOrderItem(int aQuantity, Order aOrder, SizedItem aItem)
  {
  ...
  public boolean addOrderItem(OrderItem aOrderItem)
  {
    ...
    FashionStoreManagement existingFashionStoreManagement = aOrderItem.getFashionStoreManagement();
    boolean isNewFashionStoreManagement = existingFashionStoreManagement != null && !this.equals(existingFashionStoreManagement);
    if (isNewFashionStoreManagement)
    {
      aOrderItem.setFashionStoreManagement(this);
    }
    else
    {
  ...
  {
    boolean wasRemoved = false;
    //Unable to remove aOrderItem, as it must always have a fashionStoreManagement
    if (!this.equals(aOrderItem.getFashionStoreManagement()))
    {
  ...
  /* Code from template association_AddManyToOne */
  public ShipmentItem addShipmentItem(int aQuantity, Shipment aShipment, SizedItem aItem)
  {
  ...
  public boolean addShipmentItem(ShipmentItem aShipmentItem)
  {
    ...
    FashionStoreManagement existingFashionStoreManagement = aShipmentItem.getFashionStoreManagement();
    boolean isNewFashionStoreManagement = existingFashionStoreManagement != null && !this.equals(existingFashionStoreManagement);
    if (isNewFashionStoreManagement)
    {
      aShipmentItem.setFashionStoreManagement(this);
    }
    else
    {
  ...
  {
    boolean wasRemoved = false;
    //Unable to remove aShipmentItem, as it must always have a fashionStoreManagement
    if (!this.equals(aShipmentItem.getFashionStoreManagement()))
    {
  ...
  public void delete()
  {
    ...
    if (existingManager != null)
    {
      ...
      existingManager.setFashionStoreManagement(null);
    }
    while (orders.size() > 0)
    {
    ...
    while (sizedItems.size() > 0)
    {
      SizedItem aSizedItem = sizedItems.get(sizedItems.size() - 1);
      aSizedItem.delete();
      sizedItems.remove(aSizedItem);
    }
